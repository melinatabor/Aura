...
const PERFILES = [
  {
    ...
    descripcion: 'Organizá tus turnos, tratamientos y clientes, trabajando desde un mismo lugar.',
  },
  {
    icono: '🏛',
    titulo: 'Centro estético',
    descripcion: 'Centralizá la agenda, las fichas de tus clientes y la atención de tu equipo.',
  },
  {
    icono: '👥',
    titulo: 'Equipo de trabajo',
    descripcion: 'Compartí agenda, turnos y seguimientos con visibilidad clara para todo el equipo.',
  },
]
  ...
  return (
    <div className="home-page">
      <section className="home-hero">
        <div className="home-hero-copy">
          ...
          <div className="home-hero-actions">
            <Link to="/activacion-cuenta" className="btn btn-primary">
              Registrate
            </Link>
      ...
      <section className="home-section">
        ...
        <div className="home-perfiles">
          {PERFILES.map((perfil) => (
            <div key={perfil.titulo} className="aura-card home-perfil-card">
              <div className="home-perfil-icon">{perfil.icono}</div>
              <h3>{perfil.titulo}</h3>
